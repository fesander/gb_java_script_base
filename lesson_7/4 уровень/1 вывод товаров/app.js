...
function clickHandler(event) {
    ...
    products.innerHTML = "";
    let button_data = event.target.attributes['data-type'].value;
    showCategory(button_data)
}
...
function showCategory(category) {
    ...
    products[category].forEach(product => {
        productHtml += getProductMarkup(product)
    }) 

    let div_products = document.querySelector(".products");
    div_products.insertAdjacentHTML("beforeend", productHtml);
}
